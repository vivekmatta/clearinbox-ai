...
export async function generateSummary(apiKey, emails, classifications) {
  ...
  const prompt = `You are a personal email assistant. Write a brief, scannable inbox digest.
...
- Group related items ("2 bills due this week")
- Mention who needs a reply and about what
- End with a one-line note about how many newsletters/spam can be skipped
- Be specific (use sender names, amounts, dates from subjects)
- Keep each bullet under 25 words
- Keep total under 120 words

Return JSON: { "headline": "one-line headline under 10 words", "bullets": ["...", "..."] }`;
